...
type CalendarProps = React.ComponentProps<typeof DayPicker> & {
  ...
  /** 월/요일 포맷용 문자열 로케일 */
  i18nLocale?: string; // DayPicker의 locale(객체 타입)과 안 부딪치게 이름 변경
};
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 [--cell-size:44px] sm:[--cell-size:40px] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
        // RTL 보정 (언더스코어 이스케이프 필요)
      ...
      formatters={{
        // 월 드롭다운 포맷(명시적 locale 사용)
        formatMonthDropdown: (date) =>
          date.toLocaleString(i18nLocale, { month: "short" }),
        ...formatters,
      }}
      classNames={{
        ...
        button_previous: cn(
          buttonVariants({ variant: safeButtonVariant }),
